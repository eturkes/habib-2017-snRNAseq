...
names(clust) <- c("Sample Name", "Habib 2017 Clusters")
clust[["Habib 2017 Clusters"]] <- as.factor(clust[["Habib 2017 Clusters"]])

all(col_dat[["Sample Name"]] == clust[["Sample Name"]])

cname = c(
  "exPFC1", "exPFC2", "exCA1", "exCA3", "GABA1", "GABA2", "exDG", "ASC1", "ASC2", "ODC1", "ODC2",
    "OPC", "MG", "NSC", "END", rep(NA, 4)
)
ctype = c(
  "exPFC", "exPFC", "exCA1", "exCA3", "GABA", "GABA", "exDG", "ASC", "ASC", "ODC", "ODC", "OPC",
    "MG", "NSC", "END", rep(NA,4)
)

map_clust_name <- data.frame(
  "Habib 2017 Clusters" = as.factor(seq(19)),
  "Habib 2017 Cluster Name" = cname,
  "Habib 2017 Cluster Type" = ctype
)
...
names(df_tsne) = c("sample_name", paste0("Habib 2017 TSNE", 1:2))
