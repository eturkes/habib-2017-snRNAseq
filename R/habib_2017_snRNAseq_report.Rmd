...
packages <- c(
  ...
  "dplyr", "SummarizedExperiment", "DropletUtils", "scater", "scran", "BiocSingular",
  "ggplot2", "plotly", "svd", "Rtsne", "S4Vectors")
...
First we plot several tSNEs over a range of perplexity values to find the one that best represents our data.
Rather large values are chosen to achieve tighter clusters similar to that in @habib_massively_2017.
