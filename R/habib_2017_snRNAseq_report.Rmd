...
```{r, include = FALSE}
rm(gg_df, label_df, label_df2, sce, sce_hvg, sce_orig)
```
...
if (file.exists(rds)) {
  ...
  seurat <- FindClusters(seurat, resolution = 1.05)
  saveRDS(seurat, rds)}
```
...
dim_red_plot(
  data = gg_df, x = "hvg_tsne1", y = "hvg_tsne2", col = "seurat_clusters", type = "cat") +
  xlab("tSNE 1") + ylab("tSNE 2") + ggtitle("Seurat Clusters HVG tSNE")
```
