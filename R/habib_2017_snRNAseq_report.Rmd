...
We use several approaches to identify clusters using tSNE, so this section is broken down into multiple subsections.
Let's define a function for consistant plotting throughout.
...
We also calculate and plot new t-SNE coordinates.
