...
Note that the new clusters currently lack cell-type labels, it is planned for these to be added.
Furthermore, the cluster "Unlabeled2", corresponding to Cluster 17, is removed, as it was determined to be entirely composed of ribosomal cells.
This cluster, as well as the other "Unlabeled" clusters, do not appear in the final figures of @habib_massively_2017.
...
```{r, include = FALSE}
df_hvg <- plyr::rename(
  df_hvg, c("habib_cluster_name" = "habib_clust", "km_17_clusters" = "km_clust"))
```
...
Now that new clusters have been generated, we assess their agreement with those in @habib_massively_2017.

### tSNE {.tabset}

We visualize our clusters and those in @habib_massively_2017 using both their tSNE coordinates the the HVG tSNE calculated earlier.
