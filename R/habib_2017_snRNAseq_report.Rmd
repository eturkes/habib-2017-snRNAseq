...
```{r}
packages <- c(
  "conflicted", "BiocFileCache", "data.table", "DT", "Matrix", "plyr", "SingleCellExperiment",
  "biomaRt", "dplyr", "SummarizedExperiment", "DropletUtils", "scater", "scran", "BiocSingular",
...
map_clust_name <- data.frame(
  habib_cluster = as.factor(seq(19)), habib_cluster_name = cname,
  habib_cell_type = ctype, check.names = FALSE)
clust <- join(
