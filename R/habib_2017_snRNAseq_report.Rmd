...
packages <- c(
  ...
  "biomaRt", "dplyr", "SummarizedExperiment", "DropletUtils", "scater", "scran",
  "BiocSingular", "ggplot2", "plotly", "svd", "Rtsne", "S4Vectors")
...
Using our HVG PCs we calculate and plot the tSNEs.
...
if (file.exists(rds)) {
  ...
  for (i in num_clust) {
    cat(paste0("k-means with ", i, " clusters.\n"))
    kmeans_out <- kmeans(
