...
```{r}
sc3_plot_consensus(sce, k = all_ks, show_pdata = p_data)
```
...
```{r}
sc3_plot_silhouette(sce, k = all_ks)
```
...
```{r}
sc3_plot_expression(sce, k = all_ks, show_pdata = p_data)
```
...
```{r}
sc3_plot_de_genes(sce, k = all_ks, show_pdata = p_data)
```
...
```{r}
sc3_plot_markers(sce, k = all_ks, show_pdata = p_data)
```
