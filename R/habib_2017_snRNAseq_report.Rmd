...
We also use minimal metadata, as that will be mainly manipulated with the SCE object.
...
We add annotations based on the hg19 reference gnome, the same used in @habib_massively_2017, to the SCE object.
