...
```{r}
names(tsne) = c("Sample", paste0("Habib t-SNE ", 1:2))
...
This section details steps taken to reduce the dimensionality of the dataset through methods like PCA, t-SNE, UMAP, etc.

## Highly Variable Genes

We start by identifying highly variable genes (HVGs), which is the first step in many PCA/t-SNE approaches.
...
df_redDim <- data.frame(
  colData(sce)[ , c(
    "Sample", "Cell ID Stem", paste0("Habib t-SNE ", 1:2), "log10_total_features_by_counts",
    "Habib Cluster", "Habib Cluster Name", "Habib Cell Type")],
