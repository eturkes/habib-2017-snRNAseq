---
title: "Habib 2017 snRNAseq PFC GABA Report"
author:
  - name: "Emir Turkes"
...
knit:
  (function(inputFile, encoding) {
    rmarkdown::render(
      ...
      output_file = "../results/habib-2017-snRNAseq-PFC-GABA-report.html")})
---
...
It is possible to convert SCE objects into Seurat objects.
We do so and then cluster using Seurat.
...
```{r}
saveRDS(sce, file = file.path(results_dir, "data", "PFC_GABA_sce.rds"))
saveRDS(sce_hvg, file = file.path(results_dir, "data", "PFC_GABA_sce_hvg.rds"))
saveRDS(all_clust_res, file = file.path(results_dir, "data", "PFC_GABA_all_clust_res.rds"))
```
