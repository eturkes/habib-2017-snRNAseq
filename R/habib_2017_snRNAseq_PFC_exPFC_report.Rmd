---
title: "Habib 2017 snRNAseq PFC exPFC Report"
author:
  - name: "Emir Turkes"
...
knit:
  (function(inputFile, encoding) {
    rmarkdown::render(
      ...
      output_file = "../results/habib-2017-snRNAseq-PFC-exPFC-report.html")})
---
...
```{r}
saveRDS(sce, file = file.path(results_dir, "data", "PFC_exPFC_sce.rds"))
saveRDS(sce_hvg, file = file.path(results_dir, "data", "PFC_exPFC_sce_hvg.rds"))
saveRDS(all_clust_res, file = file.path(results_dir, "data", "PFC_exPFC_all_clust_res.rds"))
```
